...
<html lang="ko">
  ...
  <div class="form-group">
    <input type="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="이메일">
    <small id="emailHelp" class="form-text text-muted">아이디를 잊으셨습니까? 이메일을 통해 아이디를 찾으십시오.</small>
  </div>
